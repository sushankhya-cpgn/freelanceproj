...
import { Helmet } from "react-helmet"; // For head management in React Router apps
...
const HowToFindWork = () => {
  ...
  return (
    <>
      <Helmet>
        <title>How Does THEWORKLABS Talent Work for Freelancers | THEWORKLABS Talent</title>
      </Helmet>
      {/* If HeadTag is custom and still needed, keep it; otherwise, replace with Helmet */}
      <HeadTag title="How Does THEWORKLABS Talent Work for Freelancers | THEWORKLABS Talent" />
                ...
                <div className="border-t border-zinc-300 flex md:flex-row flex-col justify-between mt-7 md:space-y-0 space-y-2">
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center space-x-1 2xl:text-2xl text-xl font-semibold text-zinc-500">
                      ...
                      <FaStar />
                      <FaStar />
                      <div className="2xl:text-3xl text-2xl">4.9/5</div>
                    </div>
        ...
        <main>
          ...
          <section className="container mx-auto xl:mt-14 lg:mt-10 md:mt-7 mt-5 py-3 md:px-5 sm:px-7 px-3">
            ...
            <div className="border-t border-gray-200 mt-7">
              <div className="mt-4 lg:space-y-7 space-y-5">
                <motion.div
                  className="bg-[#E6FAF6] py-4 px-4 rounded-xl flex md:flex-row flex-col md:space-x-7"
                  initial={{ y: 30, opacity: 0 }}
          ...
          <section className="container mx-auto xl:mt-14 lg:mt-10 md:mt-7 mt-5 py-3 md:px-5 sm:px-7 px-3">
            ...
            <div className="grid md:grid-cols-2 grid-cols-1 xl:gap-x-20 lg:gap-x-16 md:gap-x-7 items-center md:mt-14">
              <motion.div
                className="md:row-start-1 row-start-2 lg:row-end-2 row-end-3"
                initial={{ y: 30, opacity: 0 }}
                whileInView={{ y: 0, opacity: 1 }}
              ...
              >
                ...
                <button
                  className="bg-zinc-800 py-2 px-5 text-white transition hover:bg-zinc-600 font-semibold rounded-full lg:mt-7 mt-4"
                  onClick={() => navigate("#")}
                >
                  Find Talent
                </button>
              ...
              <motion.div
                className="md:justify-self-end justify-self-center md:items-center md:mt-0 mt-5"
                initial={{ opacity: 0 }}
          ...
          <section className="container mx-auto xl:mt-14 lg:mt-10 md:mt-7 mt-5 py-3 md:px-5 sm:px-7 px-3">
            <div className="grid lg:grid-cols-2 grid-cols-1 lg:gap-x-20 lg:gap-y-0 md:gap-y-5 gap-y-3 items-center">
              <motion.div
                className="flex sm:flex-row flex-col 2xl:space-x-10 sm:space-x-7 sm:space-y-0 space-y-5"
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
                transition={{ duration: 0.7 }}
              >
                ...
                <div className="bg-[#E6FAF6] border relative rounded-lg md:max-w-[300px] w-full">
                  ...
                  <div>
                    <div className="flex flex-wrap items-center px-3 py-2 lg:space-x-7 space-x-3">
                      <div className="bg-gray-200 px-3 py-1 rounded-full">
                        <span className="font-semibold text-zinc-600">From $175</span>
                      </div>
                      <div>
                  ...
                  <div className="flex items-center space-x-3 absolute bg-gray-100 px-1 py-1 rounded-full top-2 left-2">
                    ...
                    <h5 className="text-zinc-700 font-semibold pr-5 text-lg">Jorge L.</h5>
                  </div>
                </div>
                ...
                <div className="bg-[#E6FAF6] border relative rounded-lg md:max-w-[300px] w-full">
                  ...
                  <div className="flex items-center space-x-3 absolute bg-gray-100 px-1 py-1 rounded-full top-2 left-2">
                    ...
                    />
                    <div className="w-2 h-2 bg-green-500 rounded-full absolute left-5 bottom-2 border border-gray-200"></div>
                    <h5 className="text-zinc-700 font-semibold pr-5 text-lg">Amenda H.</h5>
                  </div>
                </div>
              </motion.div>
          ...
          <section className="container mx-auto xl:mt-14 lg:mt-10 md:mt-7 mt-5 py-3 md:px-5 sm:px-7 px-3">
            <div className="grid lg:grid-cols-2 grid-cols-1 2xl:gap-x-7 xl:gap-x-16 lg:gap-x-14 lg:gap-y-0 gap-y-5 items-center">
              ...
              <div className="2xl:space-y-7 lg:space-y-5 space-y-4">
                <motion.div
                  className="flex flex-col xl:space-y-2 space-y-1"
                  initial={{ y: 30, opacity: 0 }}
                  whileInView={{ y: 0, opacity: 1 }}
                  transition={{ duration: 0.7 }}
                >
                ...
                >
                  ...
                  <p className="text-zinc-500 xl:text-[17px] font-semibold">
                    Invoice Clients and track your earnings on THEWORKLABS Talent for a simple and streamlined process.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <div className="mt-3">
                    <Link to="#">
                      <span className="font-semibold underline text-blue-700 cursor-pointer">
          ...
          <section className="container mx-auto xl:mt-14 lg:mt-10 md:mt-7 mt-5 py-3 md:px-5 sm:px-7 px-3">
            <div className="lg:grid lg:grid-cols-2 2xl:gap-x-0 xl:gap-x-1 lg:gap-x-3 rounded-xl flex flex-col lg:items-start items-center 2xl:px-10 xl:px-5 md:px-3 sm:px-2 px-3 bg-[#dafaf3]">
              {/* ================ This is always same not change =================== */}
              <div>
              ...
              <div className="lg:px-7 sm:px-5 px-0 sm:py-5 py-3">
                <div className="border-b border-zinc-300 xl:py-7 sm:py-5 py-3 space-y-2">
                  <h4 className="xl:text-3xl sm:text-2xl text-xl font-semibold text-zinc-800">
                    Is THEWORKLABS Talent free to join as a freelancer?
                  </h4>
                  <p className="text-zinc-600 xl:text-xl sm:text-lg text-md">
                    Yes, it’s free to join THEWORKLABS Talent, complete your profile, search for work and create your own projects. Our service fee is based on your earnings with each client and the sliding scale rewards long-term relationships.
                  </p>
                </div>

                <div className="border-b border-zinc-300 xl:py-7 sm:py-5 py-3 space-y-2">
                  <h4 className="xl:text-3xl sm:text-2xl text-xl font-semibold text-zinc-800">
                    Can I grow my career on THEWORKLABS Talent?
                  </h4>
                  <p className="text-zinc-600 xl:text-xl text-lg text-md">
                    Yes, some of our most successful professionals have brought their strong background and employment track record to THEWORKLABS Talent. We know you may be new to freelancing but highly experienced in your field. Our complete guide shares our step-by-step tips for building your freelance career.
                  </p>
                </div>

                <div className="xl:py-7 sm:py-5 py-3 space-y-2">
                  <h4 className="xl:text-3xl sm:text-2xl text-xl font-semibold text-zinc-800">
                    What can I gain from freelancing with THEWORKLABS Talent?
                  </h4>
                  <p className="text-zinc-600 xl:text-xl sm:text-lg text-md">
                    Many more people like you are choosing to leave their day jobs and grow as independent professionals. Why? Because of the freedom and flexibility that comes with being your own boss. And for the chance to work with great Clients and well-known brands. Many choose THEWORKLABS Talent because we help them do it well. How to Succeed as a Freelancer gives you a taste of the support we offer to boost your success.
                  </p>
                </div>

                <div className="xl:py-7 sm:py-5 py-3 space-y-2">
                  <h4 className="xl:text-3xl sm:text-2xl text-xl font-semibold text-zinc-800">
                    Is THEWORKLABS Talent good for building a business?
                  </h4>
                  <p className="text-zinc-600 xl:text-xl sm:text-lg text-md">
                ...
                <div className="xl:py-7 sm:py-5 py-3 space-y-2">
                  <h4 className="xl:text-3xl sm:text-2xl text-xl font-semibold text-zinc-800">
                    What projects can I find on THEWORKLABS Talent?
                  </h4>
                  <p className="text-zinc-600 xl:text-xl sm:text-lg text-md">
                ...
                <div className="xl:py-7 sm:py-5 py-3 space-y-2">
                  ...
                  <p className="text-zinc-600 xl:text-xl sm:text-lg text-md">
                    Connects are THEWORKLABS Talent’s virtual currency. Freelancers and agencies use them to show their genuine interest as they submit proposals. Different jobs require different amounts of Connects, some none at all. Freelancer accounts receive free Connects every month. You can buy bundles of them. And freelancers and agencies earn Connects by winning client interviews, getting great reviews, and demonstrating their skills.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="container mx-auto xl:my-14 lg:my-10 md:my-7 my-5 py-3 md:px-5 sm:px-7 px-3">
            <motion.div
              className="grid lg:grid-cols-3 md:grid-cols-2 gap-x-7 lg:gap-y-0 md:gap-y-7 gap-y-5"
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
              transition={{ duration: 0.7 }}
            >
              <Link to="#">
                <div className="flex flex-col justify-between bg-[#dcf5f0] transition hover:bg-[#d3eee8] px-4 py-4 rounded-lg min-h-[8rem] cursor-pointer">
                  ...
                  <div className="text-blue-700 underline flex items-center transition hover:text-blue-900 mt-5 cursor-pointer">
                    Learn More
