...
const AdminCustomSupport: React.FC = () => {
    // Card Data
    const CardData = [
        {
            id: 1,
    ...
    // Work List
    const WorkList = [
        { id: 1, name: "Project Managment" },
        { id: 2, name: "Custommer Support" },
        { id: 3, name: "Virtual Assistents" },
        { id: 4, name: "eComarce Managment" },
        { id: 5, name: "Data Entry" },
        { id: 6, name: "Transcription" },
    ];
    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            <title>Top Admin & Customer support Talent Experts for Hire in July 2022 | THEWORKLABS Talent</title>
            {/* Add more meta if needed from your HeadTag component */}
            ...
            <main>
                ...
                <Flexible
                    ...
                    secondDes='Tophatter, an online auction site for shoppers worldwide, was preparing to expand and needed dozens more multilingual customer support specialists. They struggled finding enough qualified talent and finding talent within budget. By leveraging independent professionals on THEWORKLABS Talent, they were able to quickly find the customer support specialists they needed, and within budget.”'
                    secondRightText="312% increase in support capacity"
                    secondLeftBtn={{ text: "Read Case Study", link: "#" }}
                />
                <QuestionAsk
                    first firstHeadText="What is admin and customer support?"
                    ...
                    secondDesText="One of the first steps in hiring any talent is to determine which skills you need for your project. You know you need help with admin and customer support, but what specific things are you trying to do? THEWORKLABS Talent matches you with proven remote talent who can help you with all your admin and customer support needs, including"
                    thirdHeadText="What are the various ways I can connect with admin and customer support talent through THEWORKLABS Talent?"
                    ...
                    fourHeadText="Why should I use THEWORKLABS Talent to find talent for finance and accounting services?"
