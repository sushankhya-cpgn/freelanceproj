...
// import { FaStar, FaUber } from "react-icons/fa";
...
//     if (userData && userData.rool === "organization") {
//       navigate("/organtionz-user/home");
//     } else if (userData && userData.rool === "Vendor") {
//       navigate("/vendor-user/home");
//     } else if (userData && userData.rool === "freelancer") {
//       navigate("/freelancer/");
//     }
//   }, [navigate]);
...
//       <HeadTag title="THEWORKLABS Talent - The World's Work Marketplace" />
...
//               {["paypal", "adobe", "oracle", "google"].map((img) => (
//                 <span key={img}>
//                   <img
//                     src={`/images/${img}.png`}
//                     height={30}
...
//               {["microsoft", "airnob", "netflix"].map((img) => (
//                 <span key={img}>
//                   <img
//                     src={`/images/${img}.png`}
//                     height={30}
...
//             Looking for work?
//             <Link to="/jobs/all-jobs" className="ml-2 text-cyan-700 hover:underline">
//               Browse Job
//             </Link>
//           </span>
...
//             <motion.h3
//               className="text-white font-bold lg:text-6xl text-4xl lg:mt-28 mt-20 leading-tight my-3"
//               initial={{ y: "100%", opacity: 0 }}
//               whileInView={{ y: 0, opacity: 1 }}
//               transition={{ duration: 1 }}
//             >
...
//             <motion.div
//               className="grid md:grid-cols-3 grid-cols-1 gap-x-10 gap-y-3 mt-10"
//               initial={{ y: "100", opacity: 0 }}
//               whileInView={{ y: 0, opacity: 1 }}
//               transition={{ duration: 1 }}
//             >
...
//                     Clients rate professionals on THEWORKLABS Talent
//                   </span>
//                 </div>
//               </motion.div>
...
//               <motion.button className="bg-zinc-700 py-2 px-5 text-white transition hover:bg-zinc-600 font-semibold rounded-full xl:mt-16 lg:mt-7 mt-3" onClick={() => navigate("/opportunities")}
...
//                   “THEWORKLABS Talent enables us to differentiate
