...
const SubLinks1 = [
    {
        ...
        sublink: [
            ...
            { id: 11, linktext: "Job Post", link: "/job-post" },
            { id: 12, linktext: "Job Post History", link: "/organization/history" },
            { id: 13, linktext: "job notifications ", link: "/organization/job-notifications" },
        ]
    },
    ...
    },
    {
        ...
        headers: "Talent Stafinnig",
        subhead: {
            name: "Talent Stafinnig",
            des: "Learn how our recruiters find you expert developers, designers, and marketers.",
            subheadlink: { name: "Talk to Talent Stafinnig", link: "/staffing" }
        },
...
const SubLinks2 = [
    {
        id: 1,
        name: "Find a Client",
        des: "Find your dream jobs work",
        link: "/jobs/listing"
    },
    {
        id: 2,
        name: "Applications Status",
        des: "Apply Job stauts listing",
        link: "/jobs/history"
    },
    {
        id: 4,
...
// ====================== Sublinks for Why THEWORKLABS Talent ==========================
const SubLinks3 = [
    {
        id: 1,
    ...
    },
    {
        id: 3,
        name: "Reviews",
        des: "See what it's like to collaborate on THEWORKLABS Talent",
        link: "/reviews"
    },
    {
        id: 4,
