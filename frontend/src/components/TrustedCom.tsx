        ...
        <section className="container mx-auto lg:mt-10 md:mt-7 mt-3 py-3 md:px-5 sm:px-7 px-3">
            ...
            >
                ...
                <div className="flex 2xl:space-x-10 xl:space-x-7 sm:space-x-6 space-x-3">
                    <span>
                        <img src="/images/paypal.png" height={30} width={90} alt="paypal-img"/>
                    </span>
                    <span>
                        <img src="/images/adobe.png" height={30} width={90} alt="adobe-img"/>
                    </span>
                    <span>
                        <img src="/images/oracle.png" height={30} width={90} alt="oracle-img"/>
                    </span>
                    <span>
                        <img src="/images/google.png" height={30} width={90} alt="google-img"/>
                    </span>
                </div>
                <div className="flex 2xl:space-x-10 xl:space-x-7 sm:space-x-6 space-x-4">
                    <span>
                        <img src="/images/microsoft.png" height={30} width={110} alt="microsoft-img"/>
                    </span>
                    <span>
                        <img src="/images/airnob.png" height={30} width={90} alt="airbnb-img"/>
                    </span>
                    <span>
                        <img src="/images/netflix.png" height={30} width={90} alt="netflix-img"/>
                    </span>
                </div>
            </motion.div>
        </section>
